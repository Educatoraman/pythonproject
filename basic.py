...
class Seeds:
    ...
    #---------button_frame----------
        ...
        btn_frame.place(x=80,y=250,width=200,height=170)

        info_btn=Button(btn_frame,text="CROP  PRACTICES",command=self.crop_details,width=30,height=3,font=("TIMES NEW ROMAN",10,"bold"),bg="black",fg="yellow",bd=0)
